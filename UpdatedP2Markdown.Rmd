...
set.seed(300)
m <- train(as.factor(Drafted) ~ ., data = nfl, method = "nnet",
           metric = "Kappa",
           trControl = ctrl)
m
p <- predict(m, nfl)
...
# customize train() with the control list and grid of parameters 
set.seed(300)
m <- train(as.factor(Drafted) ~ ., data = nfl, method = "glmnet",
           metric = "Kappa",
           trControl = ctrl,
           family = "binomial")
m
...
# customize train() with the control list and grid of parameters 
m <- train(as.factor(Drafted) ~ ., data = nfl, method = "svmRadial",
           metric = "Kappa",
           trControl = ctrl)
m
p <- predict(m, nfl)
...
# customize train() with the control list and grid of parameters 
set.seed(300)
m <- train(as.factor(Drafted) ~ ., data = nfl, method = "C5.0",
           metric = "Kappa",
           trControl = ctrl,
           tuneGrid = grid)
m
